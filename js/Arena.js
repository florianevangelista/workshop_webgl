Arena = function(game) {
    ...
    // Création de notre lumière principale (éclairage très proche de celui que le ciel nous donne)
    ...
    materialGround.diffuseTexture = new BABYLON.Texture("assets/images/gray.jpg", scene);
    ...
    materialWall.diffuseTexture = new BABYLON.Texture("assets/images/color.jpg", scene);
